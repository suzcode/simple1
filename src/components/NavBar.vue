    ...
    <div class="relative flex h-16 items-center justify-between">
      ...
      <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
        ...
        <div class="relative ml-3">
          ...
          -->
          <Transition name="profiledisplay">
            <div v-if="show" class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
              ...
              <router-link to="/signin" class="block px-4 py-2 text-sm text-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-0">Your Profile</router-link>
...
<style scoped>
.profiledisplay-leave-active {
  transition: ease-in duration 75;
}
.profiledisplay-enter-active {
  transition: ease-out duration 100;
}
.profiledisplay-enter-to {
  transform: opacity 100 scale 100;
}
.profiledisplay-leave-to {
